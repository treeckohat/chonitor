...
# Generates an image that is correctly sized to fit across all keys of a given StreamDeck.
...
# Crops out a key-sized image from a larger deck-sized image, at the location occupied by the given key index.
